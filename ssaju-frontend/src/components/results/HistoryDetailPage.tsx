  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-night-800 rounded-xl p-5">
        ...
        <ul className="flex flex-col gap-1.5">
          {data.strengths.map((strength) => (
            <li key={strength} className="text-white text-sm leading-relaxed">
              • {strength}
            </li>
          ))}
        </ul>
      ...
      <div className="bg-night-800 rounded-xl p-5">
        ...
        <p className="text-white text-sm leading-relaxed mb-2">{data.careerRoadmap.shortTerm}</p>
        <p className="text-white text-sm leading-relaxed mb-2">{data.careerRoadmap.midTerm}</p>
        <p className="text-white text-sm leading-relaxed">{data.careerRoadmap.longTerm}</p>
      </div>
    </div>
  );
}
