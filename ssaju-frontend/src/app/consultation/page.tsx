 ...
 * AI 커리어 컨설팅 페이지 (T079)
 *
 * 흐름: 입력 폼 → 고지 문구(1.5초) → AI 로딩(20초) → 8개 섹션 스크롤 결과
 * 2026-05-13 변경: TabNavigation → ConsultationScrollView + SectionNavigator
 */
...
export default function ConsultationPage() {
  const { phase, error, disclaimerVisible, disclaimerFading, consultation, submitConsultation, reset } =
    useConsultation();
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {phase === 'result' && consultation && (
          <div className="flex flex-col gap-6">
            <ConsultationScrollView data={consultation} />
